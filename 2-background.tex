...
Tendermint consensus operates through three sequential phases, \emph{propose}, \emph{prevote}, and \emph{precommit}, which functionally correspond to the \emph{pre-prepare}, \emph{prepare}, and \emph{commit} stages of the Practical Byzantine Fault Tolerance (PBFT) algorithm. 
