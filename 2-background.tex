...
N &
Y &
N\tablefootnote{The \cite{wen2025mapbft} primary is the node with the most voting power. If  voting power changes, a new node can become the primary even without suspected failure. However, the algorithm does not perform intentional leader rotation}\\
